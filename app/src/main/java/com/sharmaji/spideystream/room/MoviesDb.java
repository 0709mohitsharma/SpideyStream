...
@androidx.room.Database(entities = {HistoryModel.class},version = 1, exportSchema = false)
public abstract class MoviesDb extends RoomDatabase {
        ...
        if (instance == null) {
            ...
            instance =
                    ...
                    Room.databaseBuilder(context.getApplicationContext(),
                                    MoviesDb.class, "Content_Database")
    ...
    private static class PopulateDbAsyncTask extends AsyncTask<Void, Void, Void> {
        PopulateDbAsyncTask(MoviesDb instance) {
            HistoryDao dao = instance.Dao();
        }
        @Override
